"""Tags Agent — one of the six Parallel Generation agents (Ch.07)."""
...
from ai.prompts.prompt_library import tags_prompt

AGENT_NAME = "tags"


async def tags_node(state: dict[str, Any]) -> dict[str, Any]:
    ...
    raw = call_llm(
        model=DEFAULT_MODELS["tags"],
        system_prompt=tags_prompt(channel_config),
        user_prompt=(
            f"Research summary:\n{research_summary}\n\n"
